...
Tip: See the full integration details in the [Website Blueprint: Integrations & Environment Variables](content/articles/website-blueprint-integrations.mdx).
...
<figure>
  <svg xmlns="http://www.w3.org/2000/svg" width="560" height="120" viewBox="0 0 560 120" role="img" aria-labelledby="vc-title vc-desc" style={{maxWidth: '560px', width: '100%', height: 'auto'}}>
    ...
    <text x="36" y="44" fill="#ffffff" font-family="Inter, Roboto, Arial, sans-serif" font-size="16" font-weight="700">Connect your GitHub repo to Vercel</text>
    <text x="36" y="72" fill="#94a3b8" font-family="Inter, Roboto, Arial, sans-serif" font-size="13">Automatic builds, previews, and simple domain setup</text>
  </svg>
...
<figure>
  <svg xmlns="http://www.w3.org/2000/svg" width="560" height="120" viewBox="0 0 560 120" role="img" aria-labelledby="cf-title cf-desc" style={{maxWidth: '560px', width: '100%', height: 'auto'}}>
    ...
    <text x="36" y="48" fill="#ffffff" font-family="Inter, Roboto, Arial, sans-serif" font-size="16" font-weight="700">Cloudflare DNS & Turnstile</text>
    <text x="36" y="76" fill="#bfdbfe" font-family="Inter, Roboto, Arial, sans-serif" font-size="13">DNS, CDN, and lightweight bot protection</text>
  </svg>
...
<figure>
  <svg xmlns="http://www.w3.org/2000/svg" width="560" height="120" viewBox="0 0 560 120" role="img" aria-labelledby="ts-title ts-desc" style={{maxWidth: '560px', width: '100%', height: 'auto'}}>
    ...
    <text x="36" y="48" fill="#ffffff" font-family="Inter, Roboto, Arial, sans-serif" font-size="16" font-weight="700">Turnstile (form protection)</text>
    <text x="36" y="76" fill="#bbf7d0" font-family="Inter, Roboto, Arial, sans-serif" font-size="13">Invisible bot defense for contact forms</text>
  </svg>
...
See the starter guide: [examples/starter/README.md](examples/starter/README.md)
...
*For deep integration details and environment variables, see the [Website Blueprint: Integrations & Environment Variables](content/articles/website-blueprint-integrations.mdx).* 
