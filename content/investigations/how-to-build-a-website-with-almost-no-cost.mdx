...
depth_mode: practical
reading_pacing: steady
investigation_type: systems walkthrough
tags:
  - building
  - website
  - howto
...
<ResearchCallout title="Reading intent">
  This investigation maps a low-cost web stack from first deployment to operational discipline, with emphasis on practical trade-offs rather than tooling hype.
</ResearchCallout>

<ConceptReference
  concept="Static-first publishing"
  preview="Build as much as possible at compile time, keep runtime paths minimal, and let infrastructure stay simple until demand proves otherwise."
  investigations={["website-blueprint-integrations"]}
/>
...
<ReflectionBreak prompt="Before moving to setup steps, decide your threshold: what level of complexity are you willing to carry every month?" />
...
<ExplorationBridge
  href="/articles/website-blueprint-integrations"
  label="Go deeper into integrations and env design"
  context="When you need operational detail beyond the quickstart, continue into the full integration blueprint."
/>
