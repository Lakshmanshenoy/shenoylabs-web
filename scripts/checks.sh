...
# Validate content quality and frontmatter consistency (optional)
if [ -f "scripts/validate-content-quality.mjs" ]; then
  run_cmd content-quality "$PKG_MANAGER" run validate:content-quality
fi
